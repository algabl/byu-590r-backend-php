...
class TempleController extends BaseController
{
    ...
    public function store(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            'temple_details.architect' => 'nullable|string|max:255',
            'temple_details.square_footage' => 'nullable|integer',
            'temple_details.number_ordinance_rooms' => 'nullable|integer',
            'temple_details.number_sealing_rooms' => 'nullable|integer',
            'temple_details.number_surface_parking_spots' => 'nullable|integer',
            'temple_details.additional_notes' => 'nullable|string|max:1000',
        ]);

        if ($validator->fails()) {
            return $this->sendError('Validation Error.', $validator->errors()->toArray(), code: 400);
        }
